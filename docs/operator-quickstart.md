# Operator Quickstart — Community Travel Agency Operations

Shortest path from clone to a verified local dry-run for **ISIC 7911** (`cloud-itonami-isic-7911`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-7911.git
cd cloud-itonami-isic-7911
```
...
- Likely source path: `src/**/travel-agency-governor.cljc`
